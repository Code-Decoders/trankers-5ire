...
> The smart contracts are deployed on the 5ire Chain.
...
- Deployed on 5ire Blockchain
- Sort the upgrades based on their popularity, strengths and price

## Deployed Smart Contracts

- [The Inventory NFT Token](https://explorer.5ire.network/address/0xD7a71796213AB860e5f261D4e2eC62767a6A4Dd4)
- [The TRT In-Game-Token](https://explorer.5ire.network/address/0x81aC77864c5962482cB6E743A2ddecDee8120823)
...
```bash
  git clone https://github.com/Code-Decoders/trankers-5ire
```
